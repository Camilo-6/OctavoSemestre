...
public class MovimientoObjetivo : MonoBehaviour
{
    ...
    {
        //  Movimiento
        rb = sierra.GetComponent<Rigidbody2D>();
    ...
    private void FixedUpdate()
    {
        ...
        if (posiciones.Count > 0)
        {
            ...
            float yActual = sierra.transform.position.y;
            float ySiguiente = posiciones[0].y;
            // Si la sierra esta en una posicion para crear un objeto
    ...
    private void Activar()
    {
        ...
        Animator animator = sierra.GetComponent<Animator>();
        if (animator != null)
        {
